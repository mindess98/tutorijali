...
int main()
{
    ...
    void OslobodiMemoriju(std::vector<shared_ptr<Ucenik>> &p_ucenici);
    int broj_ucenika;
...
void ObradiUcenike(std::vector<shared_ptr<Ucenik>> &p_ucenici)
{
    ...
    std::sort(p_ucenici.begin(), p_ucenici.end(),[](shared_ptr<const Ucenik> p_u1, shared_ptr<const Ucenik> p_u2){return p_u1->prosjek > p_u2->prosjek;});
}
void ObradiJednogUcenika(shared_ptr<Ucenik> p_ucenik)
{
...
void IspisiIzvjestaj(const std::vector<shared_ptr<Ucenik>> &p_ucenici)
{
    void IspisiJednogUcenika(shared_ptr<const Ucenik> p_ucenik);
    std::cout<<std::endl;
    for(shared_ptr<const Ucenik> p_ucenik : p_ucenici)
