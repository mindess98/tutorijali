...
class Vektor3d{
    ...
    int BrojIspisa;
public:
    Vektor3d(T x, T y, T z) : koordinate{x,y,z}, BrojIspisa(0) {}
    ...
    void Ispisi()  { BrojIspisa++; cout<<"{"<<koordinate[0]<<","<<koordinate[1]<<","<<koordinate[2]<<"}";}
    ...
    Vektor3d& operator=(const Vektor3d& v){ this->koordinate[0] = v.koordinate[0];
                                            this->koordinate[1] = v.koordinate[1];
                                            this->koordinate[2] = v.koordinate[2];
                                            this->BrojIspisa = 0;}
